...
/**
 * §G これからのつながりと挑戦（3問・5段階・事前事後共通）
 * 新路線「コミュニティのチカラを活かして ライフ＆キャリアを面白くしていく」の効果を
 * 事前→事後の変化で測る設問。カタカナ（コミュニティ／デザイン）を避け、社外に縁の薄い
 * 層が入口で身構えないようにしている（フェローパネル検証・2026-09）。
 * g1=実態 / g2=自己効力 / g3=コンセプト核（まわりの力を借りて挑戦）。
 */
export const SECTION_G: ScaleSection = {
  id: "G",
  title: "これからのつながりと挑戦",
  questions: [
    { key: "g1", text: "会社や仕事の外に、一緒に何かをやれる仲間がいる" },
    { key: "g2", text: "これからの人生や仕事は、自分しだいで面白くしていけると思う" },
    { key: "g3", text: "まわりの人の力を借りながら、新しいことに挑戦できると思う" },
  ],
};
...
/**
 * §E の差し替え設問（新路線）。e3「シフト戦略…」の言い換え。
 * 既存 e3 は文言固定（過去データと比較）のため変えず、この回では e3 の代わりに使う。
 */
export const EVAL_STRATEGY_SATISFACTION: PostScaleQuestion = {
  key: "e6",
  text: "この講座でつくった「じぶんの経営戦略」は、納得できるものになった",
  kind: "likert",
};
