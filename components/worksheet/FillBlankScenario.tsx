...
function GrowInput({
  ...
  return (
    <textarea
      ...
      className={cn(
        "mx-1 inline-block resize-none overflow-hidden rounded-md border-2 border-ws-accent/50 px-2 py-1 align-middle text-xl font-bold leading-snug text-ws-ink outline-none placeholder:text-base placeholder:font-normal placeholder:text-ws-muted/50 focus:border-ws-accent",
        widthClass
      )}
    />
  );
